...
public class FpTree 
{
	private static final float sup_rate = 0.1f;
	private static long min_sup;

	public static void main(String[] args) 
	{
		List<String[]> table = fileReader.scanChart("qsar_fish_toxicity.txt", " ", "utf-8");
		min_sup = (long) (sup_rate * table.size());
		System.out.println("Absolute support value£º " + min_sup);
		System.out.println("Frequent items£º ");
...
//-------------------------------------------------------------------------------------------------
	...
	private static FpNode findFpTree(List<String[]> table, Map<String, FpNode> topHead, Map<String, Integer> frequentLink) 
	{
		...
		{
			String[] orderLine = getOrderLine(line, frequentLink);

			FpNode parent = root;
			for (String idMark : orderLine) 
			{
...
//-------------------------------------------------------------------------------------------------
	...
	private static String[] getOrderLine(String[] line, Map<String, Integer> frequentLink) 
	{
